 ...
 * Licensed MIT 
 *****************************************/
// edited for functionality with https://www.npmjs.com/package/vextension-web instead of jQuery
// customize your configuration here https://cookiebubble.netlify.app/
(function ($) {
    ...
    $.cookieBubble = function (options = {}) {
        ...
        var settings = {
            cookieMaxAge: options.cookieMaxAge || 365*6,
            messageText: options.messageText || 'We use cookies to personalize your experience. By continuing to visit this website you agree to our use of cookies.',
            messageTextColor: options.messageTextColor || undefined,
            messageFontSize: options.messageFontSize || undefined,
            buttonText: options.buttonText || 'Got it',
            buttonColor: options.buttonColor || undefined,
            buttonFontSize: options.buttonFontSize || undefined,
            iconColor: options.iconColor || undefined,
            iconVisibility: options.iconVisibility || true,
            cookiePolicyButtonText: options.cookiePolicyButtonText || 'Read Our Cookie Policy',
            cookiePolicyButtonTextColor: options.cookiePolicyButtonTextColor || undefined,
            cookiePolicyButtonUrl: options.cookiePolicyButtonUrl || 'http://allaboutcookies.org/',
            cookiePolicyButtonTarget: options.cookiePolicyButtonTarget || '_blank',
            boxAppearDelay: options.boxAppearDelay || 1000
        }
        ...
        var cookieApp = {
            ...
            checkCookie: function () {
                var get_cookie = $.getCookie(private_opt.cookieName);
                if (get_cookie != "" && get_cookie != null) {
                    ...
                    button.click(function (event) {
                        $.setCookie(private_opt.cookieName, private_opt.cookieValue, settings.cookieMaxAge);
                        $('.cookie-bubble').removeClass('show').addClass('hide');
                    });
                }
            }
