...
var vextension, version = "@VERSION"
...
vextension.postJSON = vextension.postData = vextension.postJsonData = (url, data = {}, headers = {}, options = {}, success = () => {}, dataType = 'application/json; charset=UTF-8') => {
    if (!headers["Content-Type"]) headers["Content-Type"] = dataType
    return new VextensionAjaxPromise(
        fetch(url, {
            method: 'POST',
...
// =================================== JS / STYLE Loader =================================== //
vextension.loadJS = (url, location = document.head, implementationCode = () => {}) => {
...
vextension.loadStyle = (url, location = document.head) => {
